...
class singularity_checks(rfm.RunOnlyRegressionTest):
      ...
      def setting_variables(self):
        ...
        self.prerun_cmds = ['module purge','module load default-appstack','module load singularity/3.5','module load mpich','XDG_RUNTIME_DIR=${PWD} singularity pull docker://mshaikh/hpl_mpich314:latest; export SINGULARITYENV_LD_LIBRARY_PATH=/software/lib:$LD_LIBRARY_PATH;export SINGULARITYENV_PATH=/software/bin:$_PATH','./env.sh']
...
#                                     self.stdout, 'GFlops', float)
        ...
        self.tags = {'singularity','cpu','acceptance'}
