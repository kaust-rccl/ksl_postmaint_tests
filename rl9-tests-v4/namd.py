...
class namd_check(rfm.RunOnlyRegressionTest):
    """
    Define base class for namd test.
    """
    ...
    def setting_variables(self):
        ...
        if self.variant == "rtx4090_singlegpu":
            ...
            self.executable_opts = (
                "+p8 +devices 0,1,2,3,4,5,6,7 +idlepoll  apoa1.namd".split()
            )
        ...
        if self.variant == "rtx4090_singlegpu":
            self.reference = {
                "ibex": {
                    "days_ns": (0.1, None, 0.1, "days_ns"),
                },
            }
        else:
            self.reference = {
                "ibex": {
                    "days_ns": (0.037, None, 0.1, "days_ns"),
                },
            }

        self.tags = {"namd", "gpu", self.variant, "singlenode"}
