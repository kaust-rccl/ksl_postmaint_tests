...
class openfoam_test(rfm.RunOnlyRegressionTest):
    """
    Define base class for openfoam test.
    """
    ...
    modules = ["openfoam/9.0/gnu-12.2.0"]
    time_limit = "10m"
