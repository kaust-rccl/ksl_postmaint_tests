...
class Podman_checks(rfm.RunOnlyRegressionTest):
      variant= parameter(['nfs', 'wekafs', 'tmpfs', 'nvidia-smi_test', 'rccl_anaconda_rebuild', 'load_tarball'])
      ...
      def setting_variables(self):
        ...
        if self.variant == "nfs":
          ...
          self.sanity_patterns =sn.assert_found(r'SUCCESS: Podman ran hello-world container',self.stdout)
          ...
          self.sanity_patterns =sn.assert_found(r'SUCCESS: nvidia-smi ran successfully inside the container',self.stdout)
          ...
          self.sanity_patterns =sn.assert_found(r'Container test complete',self.stdout)
