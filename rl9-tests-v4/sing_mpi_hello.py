...
class sing_mpi_hello(rfm.RunOnlyRegressionTest):
    """
    Define base class for MPI hello test using singularity.
    """
    ...
    def setting_variables(self):
        ...
        self.prerun_cmds = [
            "XDG_RUNTIME_DIR=${PWD} singularity pull docker://amrradwan/ompi-400-ubuntu-18",
            "env.sh",
        ]
        self.time_limit = "10m"
        ...
        if self.variant == "single":
            ...
            self.executable = (
                               "singularity exec "
                               "ompi-400-ubuntu-18_latest.sif "
                               "mpirun /opt/mpi_hello_world"
                               )
